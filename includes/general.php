...
function themeblvd_sliders_warning() {
	...
	if( ! get_user_meta( $current_user->ID, 'tb-nag-sliders-no-framework' ) ) {
		...
		echo '<p><a href="'.themeblvd_sliders_disable_url('sliders-no-framework').'">'.__('Dismiss this notice', 'themeblvd_sliders').'</a> | <a href="http://www.themeblvd.com" target="_blank">'.__('Visit ThemeBlvd.com', 'themeblvd_sliders').'</a></p>';
		echo '</div>';
	}
}
